...
static const char *cord[]  = { "./Downloads/lightcord","--disable-gpu-sandbox"};
static const char *furi[]  = { "firefox", NULL };
static const char *man[]  = { "pcmanfm", NULL };
